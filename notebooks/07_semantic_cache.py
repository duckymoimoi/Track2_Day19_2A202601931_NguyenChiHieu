...
# %%
cache = SemanticCache(client=client, embedder=embedder, dim=embedder.dim,
                      threshold=0.75, ttl_s=3600)
...
sweep = SemanticCache(client=client, embedder=embedder, dim=embedder.dim,
                      threshold=0.0, ttl_s=None)
for g in warm:
...
# %%
ttl_cache = SemanticCache(client=client, embedder=embedder, dim=embedder.dim,
                          threshold=0.75, ttl_s=1800)
...
# %%
leaky = SemanticCache(client=client, embedder=embedder, dim=embedder.dim,
                      threshold=0.70,
...
safe = SemanticCache(client=client, embedder=embedder, dim=embedder.dim,
                     threshold=0.70,
